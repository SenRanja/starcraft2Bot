...
class BotAI(BotAIInternal):
    ...
    def can_afford(self, item_id: UnitTypeId | UpgradeId | AbilityId, check_supply_cost: bool = True, num=1) -> bool:
        ...
        if cost.minerals * num > self.minerals or cost.vespene * num > self.vespene:
            return False
    ...
    def structures_without_construction_SCVs(self) -> Units:
        ...
        return self.structures.filter(
            lambda structure: structure.build_progress < 1
                              ...
                              and self._structures_previous_map[
                                  structure.tag].build_progress == structure.build_progress
        )
